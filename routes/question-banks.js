...
r.post('/:id/items',authorize('ADMIN'),uploadImage.single('image'),c.addItem);r.put('/:id/items/:itemId',authorize('ADMIN'),uploadImage.single('image'),c.updateItem);r.delete('/:id/items/:itemId',authorize('ADMIN'),c.removeItem);
module.exports=r;